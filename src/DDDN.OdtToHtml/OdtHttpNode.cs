...
{
	public class OdtHttpNode
	{
		private OdtHttpNode() { }

		public OdtHttpNode(string tagName, int level, OdtHttpNode parent = null) : this(tagName, parent)
		{
			Level = level;
		}

		public OdtHttpNode(string tagName, OdtHttpNode parent = null)
		{
		...
		public OdtHttpNode Parent { get; }
		public int Level { get; }
		public List<OdtHttpNode> Childs { get; set; } = new List<OdtHttpNode>();
		public Dictionary<string, List<string>> Attrs { get; } = new Dictionary<string, List<string>>(StringComparer.InvariantCultureIgnoreCase);
		...
		public static string RenderHtml(OdtHttpNode httpTag)
		{
			if (httpTag == null)
		...
		private static void HtmlNodeWalker(StringBuilder builder, OdtHttpNode httpTag)
		{
		...
		private static string RenderAtributes(OdtHttpNode httpTag)
		{
